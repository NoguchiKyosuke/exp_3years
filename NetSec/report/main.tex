...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/exp1/cpu.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/exp1/mem_percent.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/exp1/freq.png}
    \caption{基礎実験のアクセス数のグラフ}
    \label{fig:access_exp1}
\end{figure}

図\ref{fig:cpu_exp1}から、TIMER\_AFTER\_URL\_SLEEPの値が200と400の時のCPU使用率は、800の時よりも高いことがわかる。また、TIMER\_AFTER\_URL\_SLEEPのあたい
